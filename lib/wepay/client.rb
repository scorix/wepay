...
module Wepay
  class Client
    ...
    def unifiedorder
      API.post('/pay/unifiedorder').parsed_response
    end
    ...
    def orderquery
      API.post('/pay/orderquery').parsed_response
    end
    ...
    def closeorder
      API.post('/pay/closeorder').parsed_response
    end
    ...
    def refund
      API.post('/secapi/pay/refund').parsed_response
    end
    ...
    def refundquery
      API.post('/pay/refundquery').parsed_response
    end
    ...
    #   3. 对账单中涉及金额的字段单位为“元”。
    def downloadbill
      API.post('/pay/downloadbill').parsed_response
    end
    ...
    def report
      API.post('payitil/report').parsed_response
    end
  end
end